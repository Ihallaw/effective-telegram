...
# To resolve ambiguity, we will only accept formulas of the form:
# (A (operation) B), where A, B themselves are formulas or Propositional
# varaibles. 

class Formula:
    '''
    A formula requires an array of Variable objects and a string representation of
    the formula.
    ...
    def __init__(self, variables, expression, eval=None): 
